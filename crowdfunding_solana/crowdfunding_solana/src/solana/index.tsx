...
//     'A73H1dYe8MABX4mXDqV49LDq3ZJS8WnfGzAnUbyqsURL'
// );
...
//     instructions.forEach((element: Transaction | TransactionInstruction | TransactionInstructionCtorFields) => {
...
//         );
//         console.log('end sendAndSignTransaction');
//         return signature;

//     }catch(err: any){
//         console.log('signAndSendTransaction error', err.message);
//         throw err;
//     }
// }
...
//         });
//     }
//     static schema: any = new Map([[CampaignDetails,
//         {
//             kind: 'struct',
//             fields: [
//                 ['admin', [32]],
...
//     let newAccount = async() =>{ await PublicKey.createWithSeed(
//             wallet.publicKey,
//             SEED,
//             programId
//     );
...
//     const transaction = setPayerAndBlockhashTransaction(
